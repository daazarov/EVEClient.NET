...
namespace EVEClient.NET
{
    public interface IPlanetaryInteractionLogic
    {
        ...
        Task<EsiResponse<List<Colony>>> Colonies(int characterId, string? token = null);
        ...
        Task<EsiResponse<ColonyLayout>> ColonyInfo(int characterId, int planetId, string? token = null);
        ...
        Task<EsiResponsePagination<List<CustomOffice>>> CorporationCustomOffices(int corporationId, int page = 1, string? token = null);
