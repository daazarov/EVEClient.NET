...
namespace EVEOnline.ESI.Communication.Logic
{
    internal class KillmailsLogic : IKillmailsLogic
    {
        ...
        public Task<EsiResponsePagination<List<Killmail>>> GetCharacterKillmails(int characterId, int page = 1) =>
        ...
        public Task<EsiResponsePagination<List<Killmail>>> GetCorporationKillmails(int corporationId, int page = 1) =>
        ...
        public Task<EsiResponse<KillmailInfo>> GetKillmainInfo(int killmailId, string killmainHash) =>
